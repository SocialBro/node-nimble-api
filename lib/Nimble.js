...
Nimble.prototype.listContacts = function(params, callback) {
  ...
  var url = this.baseApi + '/contacts/list/?' + qs.stringify(params);
...
Nimble.prototype.listContactIds = function(params, callback) {
  ...
  var url = this.baseApi + '/contacts/list/ids?' + qs.stringify(params);
  return this._get(url, function(err, result, response) {
    if(err) return callback(err);
...
Nimble.prototype.findContactsById = function(ids, callback) {
  ...
  params['id'] = _ids;
  var url = this.baseApi + '/contacts/detail?' + qs.stringify(params);
  return this._get(url, function(err, result, response) {
    if(err) return callback(err);
    return callback(err, result, response);
  });
